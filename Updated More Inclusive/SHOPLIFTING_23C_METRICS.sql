...
report_metrics AS (
    SELECT
        ...
        LISTAGG(DISTINCT place_code, ', ') WITHIN GROUP (ORDER BY place_code) AS place_codes,
        LISTAGG(DISTINCT place_desc, ' | ') WITHIN GROUP (ORDER BY place_desc) AS place_descs
